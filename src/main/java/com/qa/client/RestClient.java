...
public class RestClient {
	...
	/**
	 * this method is used to execute the api on the basis of HTTP METHOD(GET,POST,PUT,DELETE)
	 * @param httpMethod
	 * @param request
	 * @param basePath
	 * @return
...
// generic methods for response:
	...
	/*
	 * public static void getResponse(RequestSpecification request, String endPoint,
	 * int status) { Response response =
	 * request.post(endPoint).then().assertThat().statusCode(status);
	 * 
	 * }
	 */
}
